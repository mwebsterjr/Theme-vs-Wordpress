...
<div style="background-image:url(<?php echo esc_url(get_header_image()); ?>)" id="nicdark_header_img_archive" class="nicdark_section nicdark_border_bottom_1_solid_grey <?php echo esc_attr($nicdark_archive_header_image_class); ?>">
    ...
    <div class="nicdark_container nicdark_clearfix">
    	...
    	<div class="nicdark_grid_12">
    		...
    		<?php if (is_category()): ?>
				<h1 class="nicdark_font_size_112 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Category','marina'); ?></h1>
			...
			<?php elseif (is_tag()): ?>
				<h1 class="nicdark_font_size_112 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Tag','marina'); ?></h1>
				<div class="nicdark_section nicdark_height_30"></div>
			...
			<?php elseif (is_month()): ?>
				<h1 class="nicdark_font_size_112 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Archive for','marina'); ?></h1>
				<div class="nicdark_section nicdark_height_30"></div>
			...
			<?php elseif (is_author()): ?>
				<h1 class="nicdark_font_size_112 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Author','marina'); ?></h1>
				<div class="nicdark_section nicdark_height_30"></div>
			...
			<?php else: ?>
				<h1 class="nicdark_font_size_112 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Archive','marina'); ?></h1>
			<?php endif ?>
